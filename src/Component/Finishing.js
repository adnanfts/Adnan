...
const Finishing = () => {
  ...
  const moyr=localStorage.getItem("billingOption");
  // console.log("call",moyr);
  ...
  useEffect(() => {
    const storedSelectedCheckboxes =
  ...
  return (
    <>
      ...
      >
        ...
        <div className="mt-4 finish_child_div">
          <div className="finish_box_1">
            <div style={{ textAlign: "start" }}>
              <div>
                <b>
                  <p style={{ color: "rgb(31, 31, 83)" }}>{name} ({moyr==="monthly"?`Monthly` : `Yearly`})</p>
                </b>
                <a style={{ paddingTop: "3px" }}>Change</a>
              </div>
            </div>
            <div className="finish_price">
           
              {moyr==="monthly"?`$${price}/mo` : `$${price}/yr`}
            </div>
            <hr />
            ...
            <div className="pt-2 d-flex justify-content-between">
              <div style={{ textAlign: "start" }}>
                <div>
                  <p style={{ color: "gray" }}>{name2}</p>
                </div>
              </div>
              <div className="finish_price_second">
                {/* <p> +${price2}/mo</p> */}
                {moyr==="monthly"?`$${price2}/mo` : `$${price2}/yr`}
              </div>
            </div>
            ...
            <div className="pt-3 d-flex justify-content-between">
              <div style={{ textAlign: "start" }}>
                <div>
                  <p style={{ color: "gray" }}>{name3}</p>
                </div>
              </div>
              <div className="finish_price_second">
                {/* <p>+${price3}/mo</p> */}
                {moyr==="monthly"?`$${price3}/mo` : `$${price3}/yr`}
              </div>
            </div>
            <div className="pt-3 d-flex justify-content-between">
              <div style={{ textAlign: "start" }}>
                <div>
                  <p style={{ color: "gray" }}>{name4}</p>
                </div>
              </div>
              <div className="finish_price_second">
                {/* <p>+${price4}/mo</p> */}
                {moyr==="monthly"?`$${price4}/mo` : `$${price4}/yr`}
              </div>
            </div>
          </div>
        </div>
        <div className="d-flex mt-4 justify-content-around">
          <p style={{ color: "gray" }}>Total (per {moyr==="monthly"?`month` : `year`})</p>
          <p style={{ color: "rgb(83, 83, 155)", fontWeight: "900" }}>
            {/* ${totalPerMonth} */}
            {moyr==="monthly"?`$${totalPerMonth}/mo` : `$${totalPerMonth}/yr`}
          </p>
        </div>
        ...
        >
          <Link to="/pickadd">
            <button className="btn finish_goback">Go Back</button>
          </Link>
          <Link to="/thankyou">
